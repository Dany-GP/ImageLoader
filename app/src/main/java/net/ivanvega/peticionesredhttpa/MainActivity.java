        ...
        JsonRequest jsonRequest = new JsonArrayRequest(
                ...
                null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        Gson gson = new Gson();
                        //Type lsAlbumType = new TypeToken<List<JSONArray>>(){}.getType();

                        //List<JSONArray> lsAlbum =  gson.fromJson(response.toString(), lsAlbumType);

                        Log.d("array", response.toString());

                        /*for (JSONArray item:  response){
                            try{
                                Log.d("JSONREQUEST", "name: " + item.toString());
                            }catch(Exception e){
